...
const translations: Record<Language, Record<string, string>> = {
  pl: {
    ...
    'home.subtitle': 'Łatwo organizuj mecze piłki nożnej i zarządzaj płatnościami',
    ...
    'home.organizeTitle': 'Organizuj mecze piłkarskie',
    'home.organizeSubtitle': 'Jak profesjonalista',
    'home.heroDescription': 'Kompletne rozwiązanie do organizowania meczów piłkarskich z systemem płatności za grę. Twórz wydarzenia, zbieraj płatności natychmiast i zarządzaj uczestnikami bez wysiłku.',
    ...
    'home.powerfulFeatures': 'Potężne funkcje ułatwiające organizowanie meczów piłkarskich',
    'home.quickEventCreation': 'Szybkie tworzenie wydarzeń',
    'home.quickEventDescription': 'Twórz wydarzenia piłkarskie w sekundach dzięki intuicyjnemu interfejsowi. Ustaw daty, lokalizacje i ceny z łatwością.',
    ...
    'features.event.description': 'Stwórz mecz w kilka minut - wybierz datę, miejsce i koszty',
    ...
    'auth.register.subtitle': 'Rozpocznij organizowanie meczów piłkarskich już dziś.',
    'auth.email': 'Email',
    'auth.password': 'Hasło',
    ...
    'dashboard.noEventsDescription': 'Stwórz swoje pierwsze wydarzenie piłkarskie, aby rozpocząć!',
    ...
    'manage.addParticipant': 'Dodaj uczestnika',
  ...
  en: {
    ...
    // Home page
    'home.title': 'Soccer Match Organizer',
    'home.subtitle': 'Easily organize soccer matches and manage payments',
    ...
    'home.organizeTitle': 'Organize Soccer Games',
    'home.organizeSubtitle': 'Like a Pro',
    'home.heroDescription': 'The complete solution for organizing soccer games with a pay-to-play system. Create events, collect payments instantly, and manage participants effortlessly.',
    ...
    'home.powerfulFeatures': 'Powerful features to make organizing soccer games effortless',
    'home.quickEventCreation': 'Quick Event Creation',
    'home.quickEventDescription': 'Create soccer events in seconds with our intuitive interface. Set dates, locations, and pricing with ease.',
    ...
    'home.howItWorksDescription': 'Get your soccer game organized in 3 simple steps',
    ...
    'auth.register.subtitle': 'Start organizing soccer matches today.',
    'auth.email': 'Email',
    ...
    'dashboard.noEventsDescription': 'Create your first soccer event to get started!',
    ...
    // Create Event
    'create.title': 'Create New Soccer Event',
    'create.eventName': 'Event Name',
    'create.eventNamePlaceholder': 'e.g., Friday Soccer at Orlik',
    ...
    'manage.addParticipant': 'Add Participant',
